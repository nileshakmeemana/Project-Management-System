...
const ADMIN_NAV = [
  ...
  {
    label: 'Finance', dividerBefore: true,
    items: [
  ...
  {
    label: 'Resources', dividerBefore: true,
    items: [
  ...
  {
    label: 'Admin', dividerBefore: true,
    items: [
...
const DEFAULT_NOTIFS = [
  { id:1, icon:'ti-user-plus',     text:'New employee <b>Sara Kim</b> joined',  sub:'2 days ago', unread:true  },
  { id:2, icon:'ti-clipboard-list',text:'5 tasks awaiting review',               sub:'3 days ago', unread:true  },
  { id:3, icon:'ti-cash',          text:'Payroll run for June completed',         sub:'1 week ago', unread:false },
];
